...
namespace FunctionFood.Models.Services
{
    public class AdminRepository : IAdminRepository
    {
        ...
        public AdminRepository(FunctionalFoodDatabaseContext context, UserManager<IdentityUser> userManager, RoleManager<IdentityRole> roleManager)
        {
            _context = context;
        ...
        public List<ProductTotal> GetTopProducts(int top)
        {
            return _context.InvoiceDetails
